import{r,n as f}from"./components-Ep370hT9.js";import{b as R,m as N,t as z,l as C,c as P,n as E,k as q,B as Q,I as J}from"./heading-DJdNTOqn.js";const X="/assets/gotham-book-Bnaws0Ef.woff2",Y="/assets/gotham-medium-0VT3RO8I.woff2",Z="/assets/gotham-bold-italic-C_msAlmW.woff2",ee="/assets/gotham-bold-D1kvQ7KV.woff2",te="/assets/gotham-book-italic-Bm2IEtSK.woff2",oe="/assets/gotham-medium-italic-Dok430ou.woff2",se="/assets/ipa-gothic-DimHCOud.woff2",L=r.createContext({}),ke=({theme:e="dark",children:t,className:n,as:s="div",toggleTheme:i,...a})=>{const o=W(),c=!o.theme;return f.jsxs(L.Provider,{value:{theme:e,toggleTheme:i||o.toggleTheme},children:[c&&t,!c&&f.jsx(s,{className:R(n),"data-theme":e,...a,children:t})]})};function W(){return r.useContext(L)}function y(e){return e.replace(/\s\s+/g," ")}function _(e){return y(Object.keys(e).map(t=>`--${t}: ${e[t]};`).join(`
